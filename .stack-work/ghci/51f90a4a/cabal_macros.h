...
/* package haskell-turing-machine-0.1.0.0 */
#ifndef VERSION_haskell_turing_machine
#define VERSION_haskell_turing_machine "0.1.0.0"
#endif /* VERSION_haskell_turing_machine */
#ifndef MIN_VERSION_haskell_turing_machine
#define MIN_VERSION_haskell_turing_machine(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_turing_machine */
...
#define CURRENT_COMPONENT_ID "haskell-turing-machine-0.1.0.0-B7xxcR2HY8JDbAToRnbhI-haskell-turing-machine"
